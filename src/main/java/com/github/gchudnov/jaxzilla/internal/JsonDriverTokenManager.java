/* JsonDriverTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. JsonDriverTokenManager.java */
package com.github.gchudnov.jaxzilla.internal;

/** Token Manager. */
class JsonDriverTokenManager implements JsonDriverConstants {
...
"", null, null, "\54", "\173", "\175", "\72", "\133", "\135", null, null, null, 
...
static final int[] jjnextStates = {
   15, 23, 17, 19, 13, 14, 16, 22, 3, 4, 6, 23, 17, 19, 5, 7, 
   20, 21, 
};
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public JsonDriverTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public JsonDriverTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
